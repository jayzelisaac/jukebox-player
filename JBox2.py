...
class MusicPlayer:
    ...
    def setup_ui(self):
        ...
        title_label.grid(row=0, column=0, columnspan=2, pady=20, sticky="nw")

        # Music Folder Listbox (Scrollable)
        self.playlist_frame = tk.Frame(self.root, bg="#E5B402")
        self.playlist_frame.grid(row=1, column=0, sticky="nw", padx=20)
        playlist_scrollbar = tk.Scrollbar(self.playlist_frame)
        ...
        # Music2 Folder Listbox (Scrollable)
        self.playlist2_frame = tk.Frame(self.root, bg="#E5B402")
        self.playlist2_frame.grid(row=2, column=0, sticky="nw", padx=20, pady=20)
        playlist2_scrollbar = tk.Scrollbar(self.playlist2_frame)
        self.playlist2 = tk.Listbox(
            self.playlist2_frame,
            selectmode=tk.SINGLE,
            bg="black",
            fg="white",
            font=('arial', 12),
        ...
        user_input_frame.grid(row=1, column=1, sticky="ne", padx=20, pady=20)
        ...
        status_frame.grid(row=1, column=0, columnspan=2, padx=20, pady=20, sticky="n")
        ...
        spinning_logo_frame.grid(row=2, column=1, sticky="se", padx=20, pady=20)
